...
async def seed_data(db):
    ...
    items_data = [
        ...
        ("Кинжал «Убийца монархов»", "weapon", "epic", 16, json.dumps({"attack": 35, "crit_chance": 15, "dodge_chance": 5}), "Смертоносный кинжал, выкованный из клыка дракона Антареса", "donate", 750),
